...
Preprocessing is a way to consolidate code and compile it into CSS. Instead of writing redundant lines of code you can write cleaner lines of code that can help streamline results you would get from CSS
2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?
I like variables and mixins but escaping and operations get a little confusing
3. How would you explain the concept of a variable to someone new to programming?
A variable acts like a nickname for a value that you want to use throughout LESS
4. What is the purpose of using functions in code?
Functions act as equations or shells of information that is stored within a function.
It makes calling data easier.
5. What is JSON data?
JSON is almost identical to javascript exceot for a few syntex differences
